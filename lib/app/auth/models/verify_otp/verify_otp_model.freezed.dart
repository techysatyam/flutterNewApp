...
class _$VerifyOtpModelImpl implements _VerifyOtpModel {
  const _$VerifyOtpModelImpl({@JsonKey(name: "message") this.message});
  ...
  @override
  String toString() {
    return 'VerifyOtpModel(message: $message)';
  }
...
abstract class _VerifyOtpModel implements VerifyOtpModel {
  const factory _VerifyOtpModel(
      {@JsonKey(name: "message") final String? message}) = _$VerifyOtpModelImpl;
